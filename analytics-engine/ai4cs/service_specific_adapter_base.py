...
class ServiceSpecificAdapterBase:
    ...
    def register_generic_adapter(self, hash, assetID):
    ...
    def add_knowledge_base(self, knowledge_base_id, knowledge_base_name, knowledge_base_description ):
        ...
        print(f'Knowledge base with id: {knowledge_base_id}, name:{knowledge_base_name} and description{knowledge_base_description} added. Return code {response.status_code}')
    ...
    def remove_knowledge_base(self, knowledge_base_id):
        ...
        #print(f'Knowledge base with id:{knowledge_base_id} has been deleted. Return code {response.status_code}')
        return response.status_code

    def add_knowledge_interaction(  self, knowledge_interaction_description, knowledge_interaction_type, knowledgeInteractionName,
                                    graph_pattern = None, prefixes = None, argument_graph_pattern = None, result_graph_pattern = None):
        """
        ...
        if knowledge_interaction_type == 'AskKnowledgeInteraction' or knowledge_interaction_type == 'AnswerKnowledgeInteraction':
            ...
            json_body =  {
                    ...
                    'knowledgeInteractionName': knowledgeInteractionName,
        ...
        if response.status_code == 200:
            ...
            knowledge_interaction = {   
                ...
                'graphPattern': graph_pattern,
                'argumentGraphPattern': argument_graph_pattern,                     
                'argumentGraphPattern': result_graph_pattern      
            }
            self.knowledge_interactions[knowledge_interaction_id] = knowledge_interaction
            #print(knowledge_interaction)
            print(f'Knowledge interaction with id:{knowledge_interaction_id} added successfully. Return code {response.status_code}')
        else:
    ...
    def remove_knowledge_interaction(self, knowledge_base_id, knowledge_interaction_id):
        ...
        print(f'Knwoledge interaction deleted: {response.status_code}')
        return response.status_code
    ...
    def answer_incoming_request(self, kid, handleId, binding_set):
        ...
        response_bindings = self.map_service_output_parameters_to_bindingset(kid, binding_set, service_response)
